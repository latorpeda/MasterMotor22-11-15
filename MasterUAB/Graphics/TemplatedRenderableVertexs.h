...
public:
	...
	bool Render(CKGRenderManager *RenderManager, CEffect *Effect, void *Parameters)
	{
...
public:
	...
	bool RenderIndexed(CKGRenderManager *RenderManager, CEffect *Effect, void *Parameters, unsigned int IndexCount=-1, unsigned int StartIndexLocation=0, unsigned int BaseVertexLocation=0)
	{
		if(Effect->GetPixelShader()==NULL || Effect->GetVertexShader()==NULL)
			return false;
		ID3D11DeviceContext *l_DeviceContext=RenderManager->GetDeviceContext();
